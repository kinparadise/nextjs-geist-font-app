...
export default function TiledView() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Tiled View</Text>
      {/* TODO: Add tiled video grid */}
      <TouchableOpacity style={styles.button} onPress={handleSwitchToPresentation}>
        <Text style={styles.buttonText}>Switch to Presentation View</Text>
      </TouchableOpacity>
